...
public class Player2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if(GameController.instance.hits2 < 0)
        {
            canShoot = false;
        }
    }
    ...
    void Update()
    {
        if (!isDead)
        {
            ...
            else if(GameController.instance.hits2 >= 0)
            {
                canShoot = true;
            }
            ...
            if (Input.GetKey(KeyCode.V) && Time.time > nextFire && canShoot)
            {
                nextFire = Time.time + fireRate;
                isShoot = true;
                GameController.instance.hits2--;
            }
        ...
        if (GameController.instance.Player2Hp < 0)
        {
            GameController.instance.gameOver2 = true;
